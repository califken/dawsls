!function (t, e) {
  ...
  class n extends s {
    constructor(t) {
      super(), this.isExternalMedia = !1, t.media ? (this.media = t.media, this.isExternalMedia = !0) : this.media = document.createElement("audio"), t.mediaControls && (this.media.controls = !0), t.autoplay && (this.media.autoplay = !0), null != t.playbackRate && this.onceMediaEvent("canplay", (() => {
  ...
  class r extends s {
    ...
    initEvents() {
      const t = t => {
        const e = this.wrapper.getBoundingClientRect(), i = t.clientX - e.left, s = t.clientX - e.left;
    ...
    initDrag() {
      !function (t, e, i, s, n = 5) {
        ...
        const o = o => {
          ...
          o.preventDefault(), o.stopPropagation(), t.style.touchAction = "none";
          ...
          const d = s => {
            ...
            t.style.touchAction = "", l && (null == s || s()), r()
          };
    ...
    render(t) {
      this.timeouts.forEach((t => t.timeout && clearTimeout(t.timeout))), this.timeouts = [], this.canvasWrapper.innerHTML = "", this.progressWrapper.innerHTML = "", this.wrapper.style.width = "", null != this.options.width && (this.scrollContainer.style.width = "number" == typeof this.options.width ? `${this.options.width}px` : this.options.width);
    ...
    renderProgress(t, e) {
      if (isNaN(t)) return;
      const i = 100 * t;
      this.canvasWrapper.style.clipPath = `polygon(${i}% 0, 100% 0, 100% 100%, ${i}% 100%)`, this.progressWrapper.style.width = `${i}%`, this.cursor.style.left = `${i}%`, this.cursor.style.marginLeft = 100 === Math.round(i) ? `-${this.options.cursorWidth}px` : "", this.isScrolling && this.options.autoScroll && this.scrollIntoView(t, e)
    }
  }
  ...
  class a extends s {
    ...
    set src(t) {
      this.currentSrc = t, fetch(t).then((t => t.arrayBuffer())).then((t => this.audioContext.decodeAudioData(t))).then((t => {
  ...
  class l extends n {
    ...
    constructor(t) {
      ...
      }), this.plugins = [], this.decodedData = null, this.subscriptions = [], this.mediaSubscriptions = [], this.options = Object.assign({}, h, t), this.timer = new o;
    ...
    loadAudio(s, n, r, o) {
      return t(this, void 0, void 0, (function* () {
        ...
        this.setSrc(s, n);
        const t = (yield Promise.resolve(o || this.getDuration())) || (yield new Promise((t => {
          this.onceMediaEvent("loadedmetadata", (() => t(this.getDuration())))
        })));
        if (r) this.decodedData = e.createBuffer(r, t || 0); else if (n) {
    ...
    exportPeaks({channels: t = 2, maxLength: e = 8e3, precision: i = 1e4} = {}) {
      ...
      for (let t = 0; t < s; t++) {
        ...
        for (let t = 0; t < e; t++) {
          const e = s.slice(t * o, (t + 1) * o), n = Math.max(...e);
